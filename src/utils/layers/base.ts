...
const kpdCopyright = getCopyrightLabel(
  ...
  layer: new TileLayer({
    source: new XYZ({
      ...
      tileGrid: new TileGrid({
        ...
        resolutions: [
          1322.9193125052918, 793.7515875031751, 529.1677250021168,
...
export const geoportalOrto = {
  ...
  layer: new TileLayer({
    source: new XYZ({
      ...
      tileGrid: new TileGrid({
        extent: [
          125559.50331997534, 5922338.972788963, 846285.9447728583,
          6303868.902515489,
        ],
        origin: [-5122000, 10000100],
        resolutions: [
          793.7515875031751, 529.1677250021168, 264.5838625010584,
          132.2919312505292, 66.1459656252646, 26.458386250105836,
          13.229193125052918, 6.614596562526459, 2.6458386250105836,
...
export const geoportalTopoGray = {
  ...
  layer: new TileLayer({
    source: new XYZ({
      ...
      tileGrid: new TileGrid({
        extent: [
          1845.9797000000253, 5718306.1807, 1017848.0116999997,
          6527932.799900001,
        ],
        origin: [-5122000, 10000100],
        resolutions: [
...
export const geoportalHybrid = {
  ...
  layer: new TileLayer({
    source: new XYZ({
      ...
      tileGrid: new TileGrid({
        extent: [
          236725.44661756046, 5930813.423926848, 717678.0543561094,
          6291634.374735416,
        ],
        origin: [-5122000, 10000100],
        resolutions: [
